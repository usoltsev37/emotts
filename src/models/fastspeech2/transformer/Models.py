...
import src.models.fastspeech2.transformer.Constants as Constants
from .Layers import FFTBlock

from src.models.fastspeech2.config import (
    DecoderParams,
    EncoderParams,
)
...
class Encoder(nn.Module):
    ...
    def __init__(self, config: EncoderParams, max_seq_len: int, n_phonems: int):
        super(Encoder, self).__init__()

        n_position = max_seq_len + 1
        n_src_vocab = n_phonems + 1
...
class Decoder(nn.Module):
    ...
    def __init__(self, config: DecoderParams, max_seq_len: int):
